...
!<figure style="margin: 1rem 0; text-align: center;">
  <img src="../img/UI-example.png" alt="MCP" style="display:block; margin:0 auto; max-width:100%;">
  <figcaption style="font-size: 0.9em; color: #666;">新粗野主义设计风格的 UI 组件网站</figcaption>
</figure>
